...
@media (max-width:1100px){.project-head,.project-main,.composer,.section-head{flex-direction:column;align-items:stretch}.pill-grid,.pill-grid.two,.mini-grid{grid-template-columns:1fr}.project-cover{max-width:100%;width:100%;height:220px}.project-title{font-size:42px}.finance-svg{height:240px}.summary-row,.bar-row{grid-template-columns:1fr}.board-date-wrap{width:100%;justify-content:space-between}}@page{size:A3 landscape;margin:8mm}@media print{:root{--print-scale:1}html,body{background:#fff;width:420mm;height:297mm;overflow:hidden}.wrap{max-width:none;margin:0;padding:0;width:404mm;height:281mm;overflow:hidden}.board-shell,.board-section,.chart-box,.panel,.planning-card,.progress-row,.timeline-macro-row{box-shadow:none !important;background:#fff !important}.board-shell{padding:0;border:none;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:4mm;align-items:start;transform-origin:top left;transform:scale(var(--print-scale));width:calc(404mm / var(--print-scale))}.board-header,.project-head,.section-label,.pill-grid,.pill-grid.two{grid-column:1/-1}.board-section{margin-top:0;padding:3mm;border:1px solid #d8e1ef;break-inside:avoid;page-break-inside:avoid}.chart-box{padding:3mm;break-inside:avoid;page-break-inside:avoid}.board-actions,.composer,.section-tools,.notes-btn,.toggle-list,.project-logo,.pm-modal,.screen-only,.notes-wrap,#section-notes{display:none !important}.print-only{display:block !important}.finance-svg,.reactivity-bars,.timeline-macro-track{display:none !important}.project-head{margin-top:2mm;gap:4mm}.project-main{gap:4mm}.project-cover{width:68mm;height:42mm;max-width:none;box-shadow:none}.project-title{font-size:22pt}.project-desc{font-size:10pt;line-height:1.15;margin-top:2mm}.section-label{margin:2mm 0 0}.pill-grid{gap:3mm}.pill{min-height:auto;padding:2.5mm 3mm;border-radius:12px}.pill .label{font-size:7.2pt}.pill .value{font-size:11.5pt;margin-top:1.5mm}.section-head{margin-bottom:2mm}.section-head h3{font-size:14pt}.mini-grid{gap:2.5mm}.mini-card{min-height:auto;padding:2.5mm;border-radius:12px}.mini-card .label{font-size:7.4pt}.mini-card .value{font-size:18pt;margin-top:1.5mm}.company-row{padding:2.2mm 3mm;border-radius:12px}.company-row .name,.company-row .count{font-size:8.2pt}.chart-title{font-size:8.5pt;margin-bottom:2mm}.bar-row{grid-template-columns:140px 1fr 34px;gap:2mm;margin:1.5mm 0}.bar-row .label{font-size:7.8pt}.bar-track,.progress-track,.summary-track{height:6px;border:1px solid #cbd6e8;background:#eef3fb !important}.planning-stack,.progress-block,.timeline-macro{gap:2mm}.planning-card,.progress-row,.timeline-macro-row{padding:2.5mm;border-radius:12px}.planning-card .title,.progress-row .name,.timeline-macro-title{font-size:9pt}.planning-card .sub,.timeline-macro-sub{font-size:7.2pt;margin-top:1mm}.planning-card .side,.timeline-macro-date{font-size:8pt;min-width:auto}.progress-row .meta{gap:2mm}.timeline-macro-labels{margin-top:1.5mm;font-size:7pt}.summary-row{grid-template-columns:140px 1fr 70px;gap:2mm;margin-top:1.5mm;font-size:7.8pt}.legend{font-size:7.2pt;gap:3mm;margin-bottom:2mm}.legend span::before{width:10px}.bar-fill,.progress-fill,.summary-fill.pre,.summary-fill.fac,.summary-fill.prod,.react-stick,.timeline-macro-fill{background-image:none !important}.bar-fill,.summary-fill.fac{background:#ef8d00 !important}.progress-fill{background:#3f7ee8 !important}.summary-fill.pre{background:#9db4de !important}.summary-fill.prod{background:#239b5b !important}.board-date-wrap{border:1px solid #d4dceb;background:#fff7ed;padding:1.5mm 3mm}.board-date-label{font-size:7pt}.board-date{font-size:11pt;height:auto}.board-table th,.board-table td,.reminder-table th,.reminder-table td{padding:1.6mm 2mm;font-size:7.2pt}.notes-area{min-height:12mm;border:1px solid #d8e1ef}.reminder-group{break-inside:avoid-page}.project-cover[src='']{display:none}}
</style></head>
