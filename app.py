...
@media (max-width:1100px){.project-head,.project-main,.composer,.section-head{flex-direction:column;align-items:stretch}.pill-grid,.pill-grid.two,.mini-grid{grid-template-columns:1fr}.project-cover{max-width:100%;width:100%;height:220px}.project-title{font-size:42px}.finance-svg{height:240px}.summary-row,.bar-row{grid-template-columns:1fr}.board-date-wrap{width:100%;justify-content:space-between}}@page{size:A4 landscape;margin:10mm}@media print{html,body{background:#fff}.wrap{max-width:none;margin:0;padding:0}.board-shell,.board-section,.chart-box,.panel,.planning-card,.progress-row,.timeline-macro-row{box-shadow:none !important;background:#fff !important}.board-shell{padding:0;border:none}.board-section{margin-top:8mm;padding:4mm;border:1px solid #d8e1ef;break-inside:avoid-page}.chart-box{padding:4mm;break-inside:avoid-page}.board-actions,.composer,.section-tools,.notes-btn,.toggle-list,.project-logo,.pm-modal,.screen-only{display:none !important}.notes-wrap{display:block !important}.print-only{display:block !important}.finance-svg,.reactivity-bars,.timeline-macro-track{display:none !important}.project-head{margin-top:4mm;gap:6mm}.project-main{gap:6mm}.project-cover{width:74mm;height:48mm;max-width:none;box-shadow:none}.project-title{font-size:24pt}.project-desc{font-size:11pt;line-height:1.25}.section-label{margin:4mm 0 2mm}.pill{min-height:auto;padding:3mm 4mm}.pill .label{font-size:8pt}.pill .value{font-size:13pt}.section-head h3{font-size:17pt}.bar-track,.progress-track,.summary-track{border:1px solid #cbd6e8;background:#eef3fb !important}.bar-fill,.progress-fill,.summary-fill.pre,.summary-fill.fac,.summary-fill.prod,.react-stick,.timeline-macro-fill{background-image:none !important}.bar-fill,.summary-fill.fac{background:#ef8d00 !important}.progress-fill{background:#3f7ee8 !important}.summary-fill.pre{background:#9db4de !important}.summary-fill.prod{background:#239b5b !important}.timeline-macro-labels{margin-top:2mm}.board-date-wrap{border:1px solid #d4dceb;background:#fff7ed;padding:2mm 4mm}.board-date{font-size:14pt;height:auto}.board-table th,.board-table td,.reminder-table th,.reminder-table td{padding:2.5mm 3mm;font-size:8.5pt}.notes-area{min-height:22mm;border:1px solid #d8e1ef}.reminder-group{break-inside:avoid-page}}
</style></head>
