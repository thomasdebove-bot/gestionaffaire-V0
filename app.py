...
class PointageService:
    ...
    def compute_tasks(self, planning_tasks: List[Dict[str, Any]], pointage: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for task in reversed(out):
            ...
            elif all(child.get("status") == "past" for child in children):
                task["status"] = "past"
