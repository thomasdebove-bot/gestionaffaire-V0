...
<style>
:root{--line:#dfe5ef;--ink:#122033;--muted:#6e7a90;--accent:#ef8d00;--panel:#fff;--panel2:#f8fbff;--shadow:0 12px 34px rgba(18,32,51,.07)}
*{box-sizing:border-box}body{margin:0;font-family:Inter,Segoe UI,Arial,sans-serif;background:#f3f6fb;color:var(--ink)}
.wrap{max-width:1480px;margin:20px auto;padding:0 16px}.board-shell,.board-section{background:#fff;border:1px solid var(--line);border-radius:22px;box-shadow:var(--shadow)}.board-shell{padding:22px}.board-header{display:flex;justify-content:space-between;align-items:center;gap:18px;flex-wrap:wrap}.board-brand{display:flex;align-items:center;gap:14px}.board-kicker{font-size:17px;font-weight:900;letter-spacing:.08em;color:var(--accent);text-transform:uppercase}.board-date{height:42px;padding:0 14px;border:1px solid #1d2b43;border-radius:999px;background:#fff;color:var(--ink);font:inherit;font-size:15px;font-weight:800}.board-actions{display:flex;gap:10px;flex-wrap:wrap}.action-btn{height:44px;padding:0 18px;border:1px solid #1d2b43;border-radius:999px;background:rgba(255,255,255,.94);color:var(--ink);font-size:15px;font-weight:900;letter-spacing:.02em;cursor:pointer;box-shadow:0 6px 18px rgba(18,32,51,.06)}.action-btn:hover{background:#fff}.project-head{margin-top:24px;display:flex;align-items:flex-start;justify-content:space-between;gap:22px}.project-main{display:flex;gap:24px;align-items:flex-start;min-width:0;flex:1}.project-cover{width:420px;max-width:32vw;height:240px;border-radius:24px;border:1px solid #d8e1ef;object-fit:cover;background:#fff;box-shadow:0 10px 24px rgba(16,32,56,.12)}.project-copy{min-width:0;flex:1}.project-title{margin:0;font-size:68px;line-height:.98;font-weight:900;letter-spacing:-.03em}.project-desc{margin-top:16px;font-size:25px;line-height:1.28;color:#697991}.project-logo{width:88px;height:88px;border-radius:18px;border:1px solid var(--line);padding:12px;background:#fff;object-fit:contain;flex:0 0 auto}.section-label{margin:26px 0 10px;font-size:16px;font-weight:900;color:var(--accent);text-transform:uppercase;letter-spacing:.02em}.pill-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.pill-grid.two{grid-template-columns:repeat(2,minmax(0,1fr))}.pill{border:2px solid #1d2b43;border-radius:24px;padding:14px 18px;background:#fff;min-height:82px}.pill .label{font-size:14px;font-weight:900;text-transform:uppercase}.pill .value{margin-top:8px;font-size:22px;font-weight:900}.composer{margin-top:24px;display:flex;justify-content:space-between;gap:18px;align-items:center;flex-wrap:wrap}.composer-title{font-size:17px;font-weight:900;color:var(--accent);text-transform:uppercase}.toggle-list{display:flex;gap:10px;flex-wrap:wrap}.toggle-chip{display:inline-flex;align-items:center;gap:8px;border:2px solid #1d2b43;border-radius:999px;padding:6px 14px;background:#fff;font-size:14px;font-weight:900}.toggle-chip input{width:18px;height:18px;margin:0}.board-section{margin-top:16px;padding:14px}.section-head{display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:12px}.section-head h3{margin:0;font-size:28px;font-weight:900}.notes-btn{height:32px;padding:0 12px;border:1px solid #1d2b43;border-radius:999px;background:#fff;font-size:12px;font-weight:900;cursor:pointer}.section-tools{display:flex;gap:8px;flex-wrap:wrap;align-items:center}.mini-toggle{display:inline-flex;align-items:center;gap:6px;border:1px solid #1d2b43;border-radius:999px;padding:4px 10px;background:#fff;font-size:12px;font-weight:800}.mini-toggle input{width:14px;height:14px;margin:0}.panel{border:1px solid #d8e1ef;border-radius:18px;background:var(--panel2);padding:14px}.mini-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.mini-card{background:#fff;border:1px solid #dbe4f2;border-radius:18px;padding:14px;min-height:112px}.mini-card .label{font-size:13px;color:#4b5d7a;font-weight:800}.mini-card .value{margin-top:8px;font-size:38px;font-weight:900;line-height:1}.stack{display:grid;gap:14px}.company-row{display:flex;justify-content:space-between;gap:14px;align-items:center;padding:13px 16px;border:1px solid #e6ecf6;border-radius:18px;background:#fff}.company-row .name{font-size:17px;font-weight:900}.company-row .count{font-size:17px}.company-row-btn{appearance:none;-webkit-appearance:none;width:100%;text-align:left;background:none;border:none;padding:0;cursor:pointer;font:inherit;color:inherit}.company-cell{display:flex;align-items:center;gap:12px}.company-logo{width:34px;height:34px;border-radius:50%;border:1px solid #d8e0ee;background:#fff;object-fit:cover;display:inline-flex;align-items:center;justify-content:center;font-size:12px;color:#6e7a90;font-weight:800}.chart-box{border:1px solid #d8e1ef;border-radius:18px;background:#fff;padding:16px}.chart-title{font-size:15px;font-weight:900;margin:0 0 10px}.bar-row{display:grid;grid-template-columns:minmax(220px,300px) 1fr 56px;gap:14px;align-items:center;margin:12px 0}.bar-row .label{font-size:16px;font-weight:900}.bar-track{height:14px;border-radius:999px;background:#edf2f8;overflow:hidden}.bar-fill{height:100%;background:linear-gradient(90deg,#ef8d00,#ffbc62)}.reactivity-bars{display:flex;align-items:flex-end;gap:18px;height:260px;padding:10px 8px 0}.react-col{flex:1;min-width:72px;text-align:center}.react-stick{margin:0 auto;width:44px;border-radius:14px 14px 0 0;background:#d64545}.react-stick.tempo{background:#ef8d00}.react-name{font-size:12px;font-weight:900;margin-top:10px}.react-val{font-size:12px;color:#6e7a90}.planning-card{border:1px solid #d8e1ef;border-radius:18px;background:#fff;padding:16px}.planning-card .head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.planning-card .title{font-size:18px;font-weight:900;margin:0}.planning-card .sub{margin-top:4px;font-size:14px;color:#6f7f97}.planning-card .side{min-width:160px;text-align:right;font-size:16px;font-weight:900}.planning-stack{display:grid;gap:12px}.progress-block{display:grid;gap:12px}.progress-row{background:#fff;border:1px solid #d8e1ef;border-radius:18px;padding:16px}.progress-row .meta{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.progress-row .name{font-size:16px;font-weight:900}.progress-track{height:16px;border-radius:999px;background:#edf2f8;overflow:hidden;margin-top:10px}.progress-fill{height:100%;background:linear-gradient(90deg,#1b6ef3,#5da2ff)}.timeline-macro{display:grid;gap:12px}.timeline-macro-row{border:1px solid #d8e0ee;border-radius:22px;padding:18px;background:#fff}.timeline-macro-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-start}.timeline-macro-title{font-size:24px;font-weight:900}.timeline-macro-sub{margin-top:6px;font-size:15px;color:#6f7f97;text-transform:uppercase}.timeline-macro-date{font-size:22px;font-weight:900;white-space:nowrap}.timeline-macro-track{position:relative;height:32px;border-radius:999px;background:linear-gradient(90deg,#eef3fb,#f7faff);margin-top:16px;overflow:hidden}.timeline-macro-fill{position:absolute;top:0;height:100%;border-radius:999px;background:linear-gradient(90deg,#f5a623,#ef8d00)}.timeline-macro-marker{position:absolute;top:-3px;width:3px;height:38px;background:#788395}.timeline-macro-labels{display:flex;justify-content:space-between;gap:10px;margin-top:10px;font-size:13px;color:#5b6880;font-weight:700}.finance-svg{width:100%;height:320px;display:block;border:1px solid #edf2f8;border-radius:18px;background:#fff}.legend{display:flex;gap:16px;flex-wrap:wrap;align-items:center;font-size:13px;font-weight:800;margin-bottom:8px}.legend span::before{content:'';display:inline-block;width:16px;height:4px;border-radius:999px;margin-right:6px;vertical-align:middle}.legend .pre::before{background:#9db4de}.legend .fac::before{background:#ef8d00}.legend .prod::before{background:#239b5b}.summary-row{display:grid;grid-template-columns:220px 1fr 120px;gap:12px;align-items:center;margin-top:12px}.summary-track{height:12px;border-radius:999px;background:#eaf0f8;overflow:hidden}.summary-fill.pre{background:#9db4de;height:100%}.summary-fill.fac{background:#ef8d00;height:100%}.summary-fill.prod{background:#239b5b;height:100%}.board-table{width:100%;border-collapse:collapse}.board-table th,.board-table td{padding:12px 14px;border-bottom:1px solid #e6ecf6;text-align:left;font-size:14px}.board-table th{font-size:12px;text-transform:uppercase;color:#617089}.board-table td.num{text-align:right}.notes-wrap{display:none;margin-top:12px}.notes-wrap.open{display:block}.notes-area{width:100%;min-height:110px;border:1px dashed #cfd8e8;border-radius:16px;padding:14px;font:inherit;font-size:14px;background:#fff;resize:vertical}.notes-help{margin-top:6px;font-size:12px;color:var(--muted)}.pm-modal{position:fixed;inset:0;background:rgba(11,20,33,.45);display:flex;align-items:center;justify-content:center;padding:20px;z-index:50}.pm-modal-box{background:#fff;border-radius:18px;max-width:min(1480px,96vw);width:100%;max-height:86vh;overflow:auto;padding:16px;border:1px solid #d8e0ee}.hidden{display:none !important}
@media (max-width:1100px){.project-head,.project-main,.composer,.section-head{flex-direction:column;align-items:stretch}.pill-grid,.pill-grid.two,.mini-grid{grid-template-columns:1fr}.project-cover{max-width:100%;width:100%;height:240px}.project-title{font-size:46px}.finance-svg{height:240px}.summary-row,.bar-row{grid-template-columns:1fr}}@media print{body{background:#fff}.wrap{max-width:none;margin:0;padding:0}.board-shell,.board-section{border:none;box-shadow:none;border-radius:0}.board-shell{padding:0}.board-actions,.composer,.section-tools,.notes-btn{display:none !important}.notes-wrap{display:block !important}.board-section,.chart-box,.planning-card,.progress-row,.panel{break-inside:avoid-page}.project-title{font-size:48px}.project-desc{font-size:20px}}
</style></head>
<body><div class='wrap'><div class='board-shell'>
  <div class='board-header'>
    <div class='board-brand'><div class='board-kicker'>BOARD CLIENT DU <input id='boardDate' class='board-date' type='date'></div></div>
  ...
  <section id='section-analysis' class='board-section'>
    ...
    <div id='chart-analysis-reactivity' class='chart-box' style='margin-top:14px'>
      ...
      <div id='analysisReactivity' class='reactivity-bars'></div>
    </div>
  ...
  <section id='section-planning' class='board-section'>
    ...
    <div id='chart-planning-resources' class='chart-box' style='margin-top:14px'><div class='chart-title'>Retard moyen par ressource, suivant planning pointé</div><div id='planningResources' class='reactivity-bars'></div></div>
    <div id='chart-planning-resources-today' class='chart-box' style='margin-top:14px'><div class='chart-title'>Retard moyen par ressource à date</div><div id='planningResourcesToday' class='reactivity-bars'></div></div>
    ...
    <div id='chart-planning-cst' class='chart-box' style='margin-top:14px'><div class='chart-title'>Chronologie des tâches CST</div><div id='planningCst' class='timeline-macro'></div></div>
  ...
  <section id='section-finance' class='board-section'>
    ...
    <div id='chart-finance-curve' class='chart-box'><div class='legend'><span class='pre'>Prévisionnel</span><span class='fac'>Facturation</span><span class='prod'>Production</span></div><svg id='financeChart' class='finance-svg' viewBox='0 0 980 320' preserveAspectRatio='none'></svg><div id='financeSummary'></div></div>
...
function renderVerticalBars(rootId,items,{tempoName='tempo',suffix=' j'}={}){const root=document.getElementById(rootId);if(!root)return;if(!items.length){root.innerHTML=`<div class='company-row'><span class='name'>Aucune donnée</span><span class='count'>0</span></div>`;return;}const max=Math.max(1,...items.map(x=>Math.abs(Number(x.avg_gap_days??x.avg??0))));root.innerHTML=items.map(x=>{const val=Number(x.avg_gap_days??x.avg??0);const h=Math.max(8,(Math.abs(val)/max)*190);const cls=normalizeText(x.name||'')===tempoName?'tempo':'';return `<div class='react-col'><div class='react-stick ${cls}' style='height:${h}px'></div><div class='react-name'>${esc(x.name||'-')}</div><div class='react-val'>${val.toFixed(1)}${suffix}</div></div>`;}).join('');}
...
async function init(){restoreLayout();restoreNotes();document.querySelectorAll('[data-notes-target]').forEach(btn=>btn.addEventListener('click',()=>toggleNotes(btn.getAttribute('data-notes-target'))));document.getElementById('exportBtn').addEventListener('click',exportBoard);document.getElementById('importBtn').addEventListener('click',()=>document.getElementById('importInput').click());document.getElementById('importInput').addEventListener('change',async e=>{if(e.target.files&&e.target.files[0]){await importBoard(e.target.files[0]);e.target.value='';}});document.getElementById('printBtn').addEventListener('click',()=>window.print());document.getElementById('closeBtn').addEventListener('click',()=>window.close());if(!affaireId){setText('projectTitle','Aucune affaire sélectionnée');return;}const finance=await api(`/api/finance/affaire/${encodeURIComponent(affaireId)}`);let board={};let pointage={};try{board=await api(`/api/project-management/board?affaire_id=${encodeURIComponent(affaireId)}`);}catch(_){board={};}try{pointage=await api(`/api/project-management/pointage?affaire_id=${encodeURIComponent(affaireId)}`);}catch(_){pointage={};}const affaire=(finance&&finance.affaire)||{};const billed=Number(affaire.facturation_totale||((affaire.anteriorite||0)+(affaire.facture_2026||affaire.facturation_cumulee_2026||0)));const budget=Number(affaire.commande_ht||0);const billedPct=budget>0?(billed/budget)*100:0;setText('projectTitle',String(affaire.affaire||affaire.display_name||affaireId).toUpperCase());setText('projectDesc',affaire.project_description||affaire.start_sentence||'Description indisponible');const img=document.getElementById('projectImage');const src=String(affaire.project_image||affaire.image_url||affaire.image||'').trim();if(src){img.src=src;}else{img.style.display='none';}setText('pillBudget',euro(affaire.commande_ht||0));setText('pillRemain',euro(affaire.reste_a_facturer||0));setText('pillBilledPct',`${billedPct.toFixed(1)} %`);const planning=computePlanningDatasets((pointage&&pointage.tasks)||[]);setText('pillPlannedPct',`${Number((planning.expected[0]||{}).value||0).toFixed(1)} %`);setText('pillPointedPct',`${(Number(affaire.pointage_progress_ratio||0)*100).toFixed(1)} %`);const p=(board&&board.kpis_pilotage)||{};setText('metroReminder',String(Number(p.rappels_ouverts_a_date||p.reminders_open_count||0)));setText('metroFollow',String(Number(p.a_suivre_ouverts||p.followups_open_count||0)));setText('metroDate',p.date_reference||p.reference_date||'-');document.getElementById('metroCompanies').innerHTML=renderCompanyRows((p.rappels_cumules_par_entreprise||p.reminders_by_company||[]));Array.from(document.querySelectorAll('.company-row-btn')).forEach(btn=>btn.addEventListener('click',()=>showCompanyReminderModal(btn.getAttribute('data-company')||'',board)));const closeModal=document.getElementById('companyReminderClose');if(closeModal)closeModal.onclick=hideCompanyReminderModal;renderBarList('analysisBars',((p.project_company_views||{}).reminder||[]).slice(0,8));renderVerticalBars('analysisReactivity',(p.reactivity_by_company||[]).slice(0,8),{tempoName:'tempo'});renderPlanningCards('planningDelay',planning.delayTrigger.map(x=>({label:x.label,subtitle:x.subtitle,side:x.side})));renderProgressRows('planningProgress',planning.perimeterProgress);renderVerticalBars('planningResources',planning.resources.map(x=>({name:x.name,avg:x.avg})),{tempoName:'cst'});renderVerticalBars('planningResourcesToday',planning.resourcesToday.map(x=>({name:x.name,avg:x.avg})),{tempoName:'cst'});renderProgressRows('planningExpected',planning.expected);renderCstTimeline(planning.cst);renderFinance(affaire);}
