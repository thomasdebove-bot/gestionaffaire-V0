...
.top{padding:14px;display:grid;grid-template-columns:auto 1fr;gap:12px;align-items:start}.logo-link{display:inline-flex;text-decoration:none}.brand-mini{display:inline-flex;align-items:center;justify-content:center;width:78px;height:78px;border:1px solid var(--line);border-radius:16px;background:#fff}.brand-mini img{width:48px;height:48px}
...
.media{display:flex;gap:12px}.hero-media{display:none}.hero-media.show{display:block}.hero-media img{width:250px;max-width:30vw;height:150px;object-fit:cover;border-radius:16px;border:1px solid var(--line)}.hero-logo{width:84px;height:84px;border-radius:14px;border:1px solid var(--line);padding:12px;background:#fff}
...
.charts{margin-top:14px;padding:16px}.chart-wrap{height:350px;border:1px solid #d5deec;border-radius:16px;padding:12px;background:linear-gradient(180deg,#fbfcff,#f4f7fd)}.cum{margin-top:12px;border:1px solid #d5deec;border-radius:16px;padding:12px;background:#fff}.row{display:grid;grid-template-columns:180px 1fr 120px;gap:10px;align-items:center;margin:10px 0}.track{height:11px;background:#edf2f9;border-radius:999px;overflow:hidden}.fill{height:100%}.pre{background:#b7caea}.fac{background:#ef8d00}.prod{background:#239b5b}
